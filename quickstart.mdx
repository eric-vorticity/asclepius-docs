...
<AccordionGroup>
  <Accordion icon="copy" title="Request a secure upload-url">
  ...
  <Accordion icon="rectangle-terminal" title="Register the file to your account">
...
<AccordionGroup>
  <Accordion icon="github" title="Determine your system configuration">
...
<Accordion icon="palette" title="Submit the system build ">
...
<AccordionGroup>
  <Accordion icon="rocket" title="Determine your simulation configuration">
    1. Commit and push your changes.
    2. Your docs will update and be live in moments!
  </Accordion>
  <Accordion icon="rocket" title="Submit the simulation">
...
<Accordion icon="rocket" title="Dive Into Your Simulation Trajectory">
...
<Accordion icon="rocket" title="Get the Zipped Output Bundle">
